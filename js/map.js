 ...
 * map.js
 */
APP.map=null; APP.curBM='carto'; APP.curKey=null; APP.curFeat=null;
APP.LG={}; APP.wfsCache={studyArea:null,nuts:null}; APP.wfsDone=false;
...
APP.setCity = async function (key) {
  ...
  // sb-wx updated by weather badge
  APP.loadWeather();
