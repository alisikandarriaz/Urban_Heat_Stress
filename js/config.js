...
// Greenness & population from GreenessData.xlsx
APP.GREENNESS = {
...
APP.LV = {
  ...
  lu:false, imp:false, study:true, nuts:true,
};
...
APP.XML_META = {
  ...
  gbif:  { t:'Species Occurrence Density',           s:'GBIF / Haus der Natur Salzburg',              a:'Biodiversity observations including Plantae from Haus der Natur.',      crs:'EPSG:4326' },
